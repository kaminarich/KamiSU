...
/*
 * Multi-Manager Signing Key Database
 *
 * This file lists all supported third-party manager signing certificates.
 * KamiSU-specific hashes live in kamisu_sign.h for easy independent updates.
 *
 * To add a new manager: append a SIZE/HASH pair here and a matching entry
 * in the apk_sign_keys[] array in apk_sign.c under
 * CONFIG_KSU_MULTI_MANAGER_SUPPORT.
 */

// weishu/KernelSU (Official)
